...
// "Network request failed" on its own never tells you WHICH host the app tried. Demoted from
// app/index.tsx (Phase 2's auth-gated entry point) to this standalone dev route — reachable by
// typing "/debug-connection" in the dev menu's URL bar — rather than deleted, since it's still the
// fastest way to check device → host networking without going through a login form first.
